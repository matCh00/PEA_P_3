...
void Tests::GA() {
    ...
    for (int num = 0; num < 3; num++) {
        ...
        if (num == 0)
            graph = new Graph("C:/Users/matic/Desktop/PEA/sourcesAsymmetricTSP/ftv33.atsp");
                    ...
                    for (int l = 0; l < mutationProbability1.size(); ++l) {
                        ...
                        for (int n = 0; n < crossType.size(); ++n) {
                            ...
                            for (int m = 0; m < crossProbability2.size(); ++m) {
                                ...
                                ga->settingsGeneticAlgorithm(timeGA[i], population[j], mutationType[k], mutationProbability1[l], crossType[n], crossProbability1[m]);
